...
map<string, Font*> Font::s_fonts;

//string Font::s_chars = "!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";

Font* Font::getDefault()
{
  return theGame.assetManager->getFont("fnt_Default");
}
...
class ReleaseTexture: public std::unary_function<FontInfo&, void>
{
public:
...
Font::~Font()
{
  ...
  {
    for_each(m_font.begin(), m_font.end(), ReleaseTexture());
  }
}
