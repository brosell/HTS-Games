...
public:
  ...
  void setHorizJust(HJUST_TYPE just) { m_horizJust = just; setDirty(true);}
  HJUST_TYPE getHorizJust() { return m_horizJust; setDirty(true);}

  void setVertJust(VJUST_TYPE just) { m_vertJust = just; setDirty(true);}
  VJUST_TYPE getVertJust() { return m_vertJust; }
  
  void setDrawBorder(bool b) { m_drawBorder = b; setDirty(true);}
