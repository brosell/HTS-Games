...
class IniDialogHelper
{
public:
  virtual UIThing* create(string type, StringMap& attributes) = 0;
};
...
public:
  ...
  */
  ...
  static void setHelper(string type, IniDialogHelper* helper)
  {
    s_helpers[type]=helper;
  }
  static void unsetHelper(string type)
  {
    s_helpers.erase(type);
  }
...
private:
  ...
  static map<string, IniDialogHelper*> s_helpers;
};
