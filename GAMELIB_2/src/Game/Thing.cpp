...
{
  if ((m_currentSkin).isValid() && m_visible)
  {
...
//{
//  map<string, AM::RotateSkinHandle>::iterator pair;
...
const CollisionBitMask* Thing::getCurrentCollisionBitMask()
{
  if ((m_currentSkin).isValid())
  {
